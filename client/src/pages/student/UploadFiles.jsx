...
import { File, FileCode, FilePlus, FileText, Presentation, } from "lucide-react";
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="card-subtitle">
            Upload your project documents including reports, presentation, and code files.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <p className="text-sm text-slate-600 mb-4">Upload your presentation report (PPT, PPTX, PDF)</p>
            <label className="btn-outline cursor-pointer"> choose File
              <input
                type="file"
                ref={presRef}
          ...
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <h3 className="text-lg font-medium text-slate-800 mb-2">Code File</h3>
            <p className="text-sm text-slate-600 mb-4">Upload your source code (ZIP, RAR)</p>
            <label className="btn-outline cursor-pointer"> choose File
              <input
                type="file"
                ref={codeRef}
