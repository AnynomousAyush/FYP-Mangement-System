...
import { submitProjectProposal } from "../../store/slices/studentSlice.js"
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="card-subtitle">
            Please fill out all section of your project proposal. Make sure to be detailed and cleared about your project goals.{" "}
          </p>
        </div>
