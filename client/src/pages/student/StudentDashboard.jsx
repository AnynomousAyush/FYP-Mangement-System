...
const StudentDashboard = () => {
  ...
  const feedbackList = dashboardStats?.feedbackList || [];
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
        ...
        <p className="text-blue-100">
          Here's your project overview and recent update.
        </p>
      </div>
        ...
        <div className="card">
          <div className="card-header flex items-center justify-between">
            ...
            <Link to={"/student/feedback"}
              className="text-sm bg-blue-500 text-white px-3 py-1 rounded-full font-medium hover:bg-blue-50 transition-all duration-300">
              View All</Link>
          </div>
      ...
      {/* UPCOMING DEADLINES & NITIFICATION */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card">
          <div className="card-header">
