            ...
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-slate-500 uppercase tracking-wide">Experties</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-1">
                    <span className={`inline-flex items-center px-3 py-1 rounded-full font-medium capitalize text-sm ${project.status === "approved"
                    ...
                    >{project?.status || "Invalid Status"}</span>
                  </div>
                </div>
              </div>
                ...
                supervisors && supervisors.map(sup => (
                  ...
                  >
                   ...
                   <div className="space-y-2 mb-4">
                    ...
                    <div>
                      <label className="text-xs font-medium text-slate-600">Expertise</label>
                      <p className="text-sm text-slate-700">{Array.isArray(sup?.experties)
                        ? sup.experties.join(", ")
                        : sup?.experties || "-"}</p>
                    </div>
                   </div>
        ...
        showRequestModal && selectedSupervisor && (
          <div className="modal-overlay">
            <div className="modal-content">
              <div className="p-6">
                <div className="flex items-center justify-betwrrn mb-4">
                  <h3 className="text-lg font-semibold text-slate-600">Request Supervision</h3>
                  <button
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end space-x-3 pt-4 border-t border-slate-200">
                    ...
                    >Cancel</button>
                    <button
                    onClick={submitRequest} className="btn-primary" disabled={!requestMessage.trim()}
                    >Send Request</button>
                  </div>
                </div>
