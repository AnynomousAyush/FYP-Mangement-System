      ...
      <div className="card">
        ...
        <div className="overflow-x-auto">
            ...
            <thead className="bg-slate-50"> 
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Student Info</th>
                  ...
                  return (
                    <tr key={student._id} className="hover:bg-slate-50">
                      <td className="px-6 py-4">
                        <div>
                          <div className="text-sm font-medium text-slate-900">{student.name} 
                          </div>
                          <div className="text-sm text-slate-500">{student.email} 
                          </div>
                        </div>
                      </td>
          ...
          showDeleteModal && studentToDelete && (
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 shadow-xl">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-slate-500 mb-4">Are you sure you want to delete this student{""}<span>{studentToDelete.name} ?This action cannot be undone.</span></p>

                <div className="flex justify-center space-x-3">
                  <button  onClick={cancelDelete} className="btn-secondary">Cancel</button>
                  <button  onClick={confirmDelete} className="btn-danger">Delete Student</button>
                </div>
              </div>
